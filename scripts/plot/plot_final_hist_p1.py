...
plt.figure(2)
n, bins, pp = plt.hist(pred, 100, normed=1, facecolor='green', alpha=0.75, label='predicted data')
n, bins, rp = plt.hist(real, 100, normed=1, facecolor='red', alpha=0.5, label='real data')
